...
const Missions = () => {
  ...
  console.log("Missions page data:", { historicalAdventures, isLoading, error });
      ...
      <div className="min-h-screen bg-sky-blue flex items-center justify-center">
        <Card className="p-8 bg-card border-4 border-border shadow-large rounded-2xl">
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-2xl font-bold text-center mb-2">Error Loading Adventures</h2>
            <p className="text-center mb-6">
              {error instanceof Error ? error.message : 'Failed to load historical adventures. Please try again.'}
            </p>
            <div className="flex gap-4 justify-center">
              <Button 
                variant="default"
      ...
      <div className="relative z-10 flex flex-col items-center px-4 py-12 min-h-screen">
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl font-bold text-primary-foreground drop-shadow-[0_2px_0_rgba(0,0,0,0.2)]">
            Journey through time and learn history!
          </p>
        </div>
        
        {/* Historical Adventure options would go here */}
